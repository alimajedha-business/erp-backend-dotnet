...
6. In Module > Application > Mappings
	- Create MappingProfile.cs
7. API > Extensions > ServiceExtensions.cs
    - Add AddModuleInfrastructures from DependencyInjection to AddInfrastructures method    
8. In Module > Application > Services
	- Implement ServiceManager.cs
9. In Module > Domain > Entities
	- Create Entities.cs
10. In Module > Infrastructure > DataAccess > ModuleDBContext.cs
	- Add Entities DbSets
11. In Module > Application > Interfaces > Repositories
