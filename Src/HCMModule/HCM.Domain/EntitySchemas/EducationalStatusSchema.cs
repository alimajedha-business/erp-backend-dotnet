...
public sealed class EducationalStatusSchema : IFilterSchema<EducationalStatus>
{
    public FilterSchema Build()
    {
        ...
        filterSchema.Fields["title"] = new FilterFieldInfo(
            PropertyName: nameof(EducationalStatus.Title),
        ...
        filterSchema.Fields["type"] = new FilterFieldInfo(
            PropertyName: nameof(EducationalStatus.Type),
