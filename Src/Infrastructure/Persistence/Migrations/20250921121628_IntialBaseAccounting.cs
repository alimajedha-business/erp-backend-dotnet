...
{
    /// <inheritdoc />
    public partial class IntialBaseAccounting : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_float_account_types", x => x.id);
                    table.ForeignKey(
                        name: "FK_float_account_types_float_account_types_parent_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_resource_and_expenditures", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_product_types", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_account_groups_account_categories_category_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_manual_float_accounts", x => x.id);
                    table.ForeignKey(
                        name: "FK_manual_float_accounts_float_account_types_float_account_type_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_manual_float_accounts_manual_float_accounts_parent_id",
                        column: x => x.parent_id,
                        principalSchema: "accounting",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_account_sets", x => x.id);
                    table.ForeignKey(
                        name: "FK_account_sets_ledgers_ledger_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_master_accounts", x => x.id);
                    table.ForeignKey(
                        name: "FK_master_accounts_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_data_imports_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_data_imports_periods_period_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ledger_periods", x => x.id);
                    table.ForeignKey(
                        name: "FK_ledger_periods_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ledger_periods_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_closing_pattern_temporary_accounts", x => x.id);
                    table.ForeignKey(
                        name: "FK_closing_pattern_temporary_accounts_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_pattern_temporary_accounts_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_pattern_temporary_accounts_resource_and_expenditures_default_resource_and_expenditure_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_closing_patterns", x => x.id);
                    table.ForeignKey(
                        name: "FK_closing_patterns_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_patterns_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_patterns_resource_and_expenditures_default_resource_and_expenditure_id",
                        column: x => x.default_resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_trash_vouchers", x => x.id);
                    table.ForeignKey(
                        name: "FK_trash_vouchers_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_vouchers_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_vouchers_voucher_types_type_id",
                        column: x => x.type_id,
                        principalSchema: "accounting",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_vouchers_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_vouchers_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_vouchers_voucher_types_type_id",
                        column: x => x.type_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_types",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_slave_accounts", x => x.id);
                    table.ForeignKey(
                        name: "FK_slave_accounts_account_categories_category_id",
                        column: x => x.category_id,
                        principalSchema: "accounting",
                        principalTable: "account_categories",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_accounts_account_groups_group_id",
                        column: x => x.group_id,
                        principalSchema: "accounting",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_accounts_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_accounts_master_accounts_master_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_accounts_slave_accounts_parent_id",
                        column: x => x.parent_id,
                        principalSchema: "accounting",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_contradictions_data_imports_data_import_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_contradictions_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_contradictions_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ledger_period_companies", x => x.id);
                    table.ForeignKey(
                        name: "FK_ledger_period_companies_ledger_periods_ledger_period_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ledger_period_companies_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ledger_period_companies_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_voucher_logs", x => x.id);
                    table.ForeignKey(
                        name: "FK_voucher_logs_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_logs_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_logs_voucher_types_old_voucher_type_id",
                        column: x => x.old_voucher_type_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_logs_voucher_types_voucher_type_id",
                        column: x => x.voucher_type_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_logs_vouchers_voucher_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_account_set_items", x => x.id);
                    table.ForeignKey(
                        name: "FK_account_set_items_account_sets_account_set_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_account_set_items_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_account_set_items_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_balance_related_account_details", x => x.id);
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_1_id",
                        column: x => x.manual_float_1_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_2_id",
                        column: x => x.manual_float_2_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_3_id",
                        column: x => x.manual_float_3_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_4_id",
                        column: x => x.manual_float_4_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_5_id",
                        column: x => x.manual_float_5_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_6_id",
                        column: x => x.manual_float_6_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_7_id",
                        column: x => x.manual_float_7_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_manual_float_accounts_manual_float_8_id",
                        column: x => x.manual_float_8_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_resource_and_expenditures_resource_and_expenditure_id",
                        column: x => x.resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_balance_related_account_details_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_slave_account_companies", x => x.id);
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_1_id",
                        column: x => x.float_type_1_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_2_id",
                        column: x => x.float_type_2_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_3_id",
                        column: x => x.float_type_3_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_4_id",
                        column: x => x.float_type_4_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_5_id",
                        column: x => x.float_type_5_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_6_id",
                        column: x => x.float_type_6_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_7_id",
                        column: x => x.float_type_7_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_float_account_types_float_type_8_id",
                        column: x => x.float_type_8_id,
                        principalSchema: "accounting",
                        principalTable: "float_account_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_slave_account_companies_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_account_companies_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_slave_account_companies_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_slave_account_standard_descriptions", x => x.id);
                    table.ForeignKey(
                        name: "FK_slave_account_standard_descriptions_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_contradiction_items", x => x.id);
                    table.ForeignKey(
                        name: "FK_contradiction_items_contradictions_contradiction_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ledger_period_company_settings", x => x.id);
                    table.ForeignKey(
                        name: "FK_ledger_period_company_settings_ledger_period_companies_ledger_period_company_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ledger_period_company_settings_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ledger_period_company_settings_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_closing_pattern_slave_companies", x => x.id);
                    table.ForeignKey(
                        name: "FK_closing_pattern_slave_companies_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_pattern_slave_companies_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_closing_pattern_slave_companies_resource_and_expenditures_default_resource_and_expenditure_id",
                        column: x => x.default_resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_closing_pattern_slave_companies_slave_account_companies_slave_company_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_trash_voucher_items", x => x.id);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_1_id",
                        column: x => x.manual_float_1_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_2_id",
                        column: x => x.manual_float_2_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_3_id",
                        column: x => x.manual_float_3_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_4_id",
                        column: x => x.manual_float_4_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_5_id",
                        column: x => x.manual_float_5_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_6_id",
                        column: x => x.manual_float_6_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_7_id",
                        column: x => x.manual_float_7_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_manual_float_accounts_manual_float_8_id",
                        column: x => x.manual_float_8_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_resource_and_expenditures_resource_and_expenditure_id",
                        column: x => x.resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_slave_account_companies_slave_company_id",
                        column: x => x.slave_company_id,
                        principalSchema: "accounting",
                        principalTable: "slave_account_companies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_items_trash_vouchers_trash_voucher_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_voucher_item_logs", x => x.id);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_1_id",
                        column: x => x.manual_float_1_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_2_id",
                        column: x => x.manual_float_2_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_3_id",
                        column: x => x.manual_float_3_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_4_id",
                        column: x => x.manual_float_4_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_5_id",
                        column: x => x.manual_float_5_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_6_id",
                        column: x => x.manual_float_6_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_7_id",
                        column: x => x.manual_float_7_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_manual_float_accounts_manual_float_8_id",
                        column: x => x.manual_float_8_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_resource_and_expenditures_resource_and_expenditure_id",
                        column: x => x.resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_slave_account_companies_slave_company_id",
                        column: x => x.slave_company_id,
                        principalSchema: "accounting",
                        principalTable: "slave_account_companies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_voucher_logs_voucher_log_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_logs_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_voucher_items", x => x.id);
                    table.ForeignKey(
                        name: "FK_voucher_items_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_1_id",
                        column: x => x.manual_float_1_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_2_id",
                        column: x => x.manual_float_2_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_3_id",
                        column: x => x.manual_float_3_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_4_id",
                        column: x => x.manual_float_4_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_5_id",
                        column: x => x.manual_float_5_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_6_id",
                        column: x => x.manual_float_6_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_7_id",
                        column: x => x.manual_float_7_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_manual_float_accounts_manual_float_8_id",
                        column: x => x.manual_float_8_id,
                        principalSchema: "accounting",
                        principalTable: "manual_float_accounts",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_master_accounts_master_id",
                        column: x => x.master_id,
                        principalSchema: "accounting",
                        principalTable: "master_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_items_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_items_resource_and_expenditures_resource_and_expenditure_id",
                        column: x => x.resource_and_expenditure_id,
                        principalSchema: "accounting",
                        principalTable: "resource_and_expenditures",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_voucher_items_slave_account_companies_slave_company_id",
                        column: x => x.slave_company_id,
                        principalSchema: "accounting",
                        principalTable: "slave_account_companies",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_items_slave_accounts_slave_id",
                        column: x => x.slave_id,
                        principalSchema: "accounting",
                        principalTable: "slave_accounts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_items_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_trash_voucher_item_attaches", x => x.id);
                    table.ForeignKey(
                        name: "FK_trash_voucher_item_attaches_trash_voucher_items_trash_voucher_item_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_trash_voucher_item_attaches_trash_vouchers_trash_voucher_id",
                        column: x => x.trash_voucher_id,
                        principalSchema: "accounting",
                        principalTable: "trash_vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_buys", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_buys_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_buys_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_buys_ttms_product_types_kala_type_id",
                        column: x => x.kala_type_id,
                        principalSchema: "accounting",
                        principalTable: "ttms_product_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ttms_buys_voucher_items_voucher_item_id",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_buys_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_contractor_infos", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_contractor_infos_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_contractor_infos_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_contractor_infos_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_contractor_infos_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_employer_infos", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_employer_infos_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_employer_infos_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_employer_infos_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_employer_infos_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    arz_type_id = table.Column<int>(type: "int", nullable: true),
                    company_id = table.Column<int>(type: "int", nullable: false),
                    kala_type_id = table.Column<int>(type: "int", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_exportations", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_exportations_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_exportations_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_exportations_ttms_product_types_kala_type_id",
                        column: x => x.kala_type_id,
                        principalSchema: "accounting",
                        principalTable: "ttms_product_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ttms_exportations_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_exportations_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_importations", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_importations_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_importations_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_importations_ttms_product_types_kala_type_id",
                        column: x => x.kala_type_id,
                        principalSchema: "accounting",
                        principalTable: "ttms_product_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ttms_importations_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_importations_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_lease_agreements", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_lease_agreements_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_lease_agreements_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_lease_agreements_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_lease_agreements_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_pre_sells", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_pre_sells_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_pre_sells_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_pre_sells_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_pre_sells_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_sells", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_sells_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_sells_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_sells_ttms_product_types_kala_type_id",
                        column: x => x.kala_type_id,
                        principalSchema: "accounting",
                        principalTable: "ttms_product_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ttms_sells_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_sells_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ttms_wages", x => x.id);
                    table.ForeignKey(
                        name: "FK_ttms_wages_ledgers_ledger_id",
                        column: x => x.ledger_id,
                        principalSchema: "accounting",
                        principalTable: "ledgers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_wages_periods_period_id",
                        column: x => x.period_id,
                        principalSchema: "accounting",
                        principalTable: "periods",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_wages_ttms_product_types_kala_type_id",
                        column: x => x.kala_type_id,
                        principalSchema: "accounting",
                        principalTable: "ttms_product_types",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ttms_wages_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ttms_wages_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_voucher_item_attaches", x => x.id);
                    table.ForeignKey(
                        name: "FK_voucher_item_attaches_voucher_items_voucher_item_id",
                        column: x => x.voucher_item_id,
                        principalSchema: "accounting",
                        principalTable: "voucher_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_voucher_item_attaches_vouchers_voucher_id",
                        column: x => x.voucher_id,
                        principalSchema: "accounting",
                        principalTable: "vouchers",
                        principalColumn: "id",
            ...
            migrationBuilder.InsertData(
                schema: "accounting",
                table: "ledgers",
                columns: new[] { "id", "code", "created_at", "description", "is_leading", "name", "name2", "updated_at" },
                values: new object[] { 1, (short)1, new DateTime(2025, 9, 21, 12, 16, 27, 260, DateTimeKind.Utc).AddTicks(4925), "", true, "دفتر کل اصلی", "Main Ledger", null });
