...
{
    /// <inheritdoc />
    public partial class CreateAccountingSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__account___3213E83FA1A74D01", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__bank_tem__3213E83FBE9F31D0", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__float_ac__3213E83F1B40CB14", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ledgers__3213E83F96A0D23B", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    updated_at = table.Column<DateTime>(type: "datetime2", nullable: true),
                    company_id = table.Column<int>(type: "int", nullable: true),
                    previous_period_id = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__periods__3213E83FFC21E5EB", x => x.id);
                    table.ForeignKey(
                        name: "periods_previous_period_id_785fc09e_fk_periods_id",
                        column: x => x.previous_period_id,
                        principalSchema: "accounting",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__resource__3213E83FDA45EACF", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__settings__3213E83FBC61BF5A", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_pro__3213E83F247EC098", x => x.id);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83F05F75178", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83F661CEB9B", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__account___3213E83FF243D197", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__manual_f__3213E83FCACCCBC5", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__account___3213E83FAC9A8426", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__master_a__3213E83F45489EAE", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__data_imp__3213E83F55523214", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ledger_p__3213E83FCD7E44E8", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__closing___3213E83F6F99372D", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__closing___3213E83F32E72338", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__trash_vo__3213E83F5C11B883", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    creator_id = table.Column<int>(type: "int", nullable: false),
                    last_modifier_id = table.Column<int>(type: "int", nullable: true),
                    last_status_modifier_id = table.Column<int>(type: "int", nullable: true),
                    ledger_id = table.Column<int>(type: "int", nullable: false),
                    module_id = table.Column<int>(type: "int", nullable: false),
                    period_id = table.Column<int>(type: "int", nullable: false),
                    type_id = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__vouchers__3213E83FD1C266AB", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__slave_ac__3213E83F3CF7412F", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__contradi__3213E83F231D5BE1", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    company_id = table.Column<int>(type: "int", nullable: false),
                    ledger_id = table.Column<int>(type: "int", nullable: false),
                    ledger_period_id = table.Column<int>(type: "int", nullable: true),
                    period_id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__ledger_p__3213E83FA4FC65EC", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83FFDA3BE8A", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__account___3213E83FA949F926", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__balance___3213E83FF8AA1645", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__slave_ac__3213E83FD842CE45", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__slave_ac__3213E83F626F9FCD", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__contradi__3213E83F1C73FCF1", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ledger_p__3213E83F939BD0F5", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__closing___3213E83FCF3D5CDC", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    receivable_doc_date = table.Column<DateOnly>(type: "date", nullable: true),
                    receivable_doc_check_no = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    receivable_doc_bank_branch = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    payable_doc_date = table.Column<DateOnly>(type: "date", nullable: true),
                    payable_doc_check_no = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    payable_doc_bank_branch = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    manual_float_1_extra_1 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    manual_float_1_extra_2 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    manual_float_1_extra_3 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    manual_float_2_extra_1 = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    attaches = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    is_tick = table.Column<bool>(type: "bit", nullable: false),
                    bank_account_for_bank_operation_id = table.Column<int>(type: "int", nullable: true),
                    bank_account_for_payable_doc_id = table.Column<int>(type: "int", nullable: true),
                    bank_for_payable_doc_id = table.Column<int>(type: "int", nullable: true),
                    bank_for_receivable_doc_id = table.Column<int>(type: "int", nullable: true),
                    bank_operation_bank_id = table.Column<int>(type: "int", nullable: true),
                    bank_operation_type_id = table.Column<int>(type: "int", nullable: true),
                    branch_id = table.Column<int>(type: "int", nullable: false),
                    company_id = table.Column<int>(type: "int", nullable: false),
                    company_unit_id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__trash_vo__3213E83F233BD0D7", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    master_code = table.Column<int>(type: "int", nullable: false),
                    slave_account_slave_code = table.Column<int>(type: "int", nullable: false),
                    detailed_account_1 = table.Column<int>(type: "int", nullable: true),
                    detailed_account_2 = table.Column<int>(type: "int", nullable: true),
                    slave_code = table.Column<int>(type: "int", nullable: false),
                    sequence = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83F40BE9493", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    master_code = table.Column<int>(type: "int", nullable: false),
                    slave_account_slave_code = table.Column<int>(type: "int", nullable: true),
                    detailed_account_1_code = table.Column<int>(type: "int", nullable: true),
                    detailed_account_2_code = table.Column<int>(type: "int", nullable: true),
                    slave_code = table.Column<int>(type: "int", nullable: false),
                    sequence = table.Column<int>(type: "int", nullable: false),
                    deal_type = table.Column<short>(type: "smallint", nullable: true),
                    cost_center_code = table.Column<string>(type: "nvarchar(18)", maxLength: 18, nullable: true),
                    ...
                    project_date = table.Column<DateOnly>(type: "date", nullable: true),
                    project_status_report = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    project_receipt = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    store_doc_type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    store_good_code = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: true),
                    store_document = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    store_good_unit_price = table.Column<decimal>(type: "numeric(20,6)", nullable: true),
                    store_good_quantity = table.Column<decimal>(type: "numeric(16,4)", nullable: true),
                    currency_amount = table.Column<decimal>(type: "numeric(24,8)", nullable: true),
                    currency_exchange_rate = table.Column<decimal>(type: "numeric(20,4)", nullable: true),
                    bank_operation_receipt = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    bank_operation_date = table.Column<DateOnly>(type: "date", nullable: true),
                    bank_operation_check_no = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    receivable_doc_date = table.Column<DateOnly>(type: "date", nullable: true),
                    receivable_doc_check_no = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    bank_operation_bank_id = table.Column<int>(type: "int", nullable: true),
                    bank_operation_type_id = table.Column<int>(type: "int", nullable: true),
                    bank_operation_type_for_payable_doc_id = table.Column<int>(type: "int", nullable: true),
                    branch_id = table.Column<int>(type: "int", nullable: false),
                    company_id = table.Column<int>(type: "int", nullable: false),
                    company_unit_id = table.Column<int>(type: "int", nullable: true),
                    cost_center_id = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83FB72E008A", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__trash_vo__3213E83F0BB07B03", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_buy__3213E83F47578066", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_con__3213E83FD517199C", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_emp__3213E83F35813795", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_exp__3213E83FE823D67B", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_imp__3213E83F540DEB5F", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_lea__3213E83FCB177D07", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_pre__3213E83FEFE02301", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_sel__3213E83F8F41EC75", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ttms_wag__3213E83F9301933C", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__voucher___3213E83FE1BDB7DC", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__account___72E12F1BBA97A93B",
                schema: "accounting",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__float_ac__2E0A7AA640082C0A",
                schema: "accounting",
                table: "float_account_types",
                column: "name_fa",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "ledger_period_companies_company_id_ledger_id_period_id_0cff0c7c_uniq",
                schema: "accounting",
                table: "ledger_period_companies",
                columns: new[] { "company_id", "ledger_id", "period_id" },
                unique: true,
                filter: "([company_id] IS NOT NULL AND [ledger_id] IS NOT NULL AND [period_id] IS NOT NULL)");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ledger_p__8880943C687374A6",
                schema: "accounting",
                table: "ledger_period_company_settings",
            ...
            migrationBuilder.CreateIndex(
                name: "ledgers_company_id_2826278c",
                schema: "accounting",
                table: "ledgers",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "ledgers_company_id_code_bcef292e_uniq",
                schema: "accounting",
                table: "ledgers",
            ...
            migrationBuilder.CreateIndex(
                name: "ledgers_company_id_name_9745962f_uniq",
                schema: "accounting",
                table: "ledgers",
            ...
            migrationBuilder.CreateIndex(
                name: "ledgers_company_id_name2_189873b9_uniq",
                schema: "accounting",
                table: "ledgers",
                columns: new[] { "company_id", "name2" },
                unique: true,
                filter: "([company_id] IS NOT NULL AND [name2] IS NOT NULL)");
            ...
            migrationBuilder.CreateIndex(
                name: "master_accounts_company_id_8105f0fd",
                schema: "accounting",
            ...
            migrationBuilder.CreateIndex(
                name: "master_accounts_ledger_id_code_company_id_ad25ea34_uniq",
                schema: "accounting",
                table: "master_accounts",
                columns: new[] { "ledger_id", "code", "company_id" },
                unique: true,
                filter: "([ledger_id] IS NOT NULL AND [code] IS NOT NULL AND [company_id] IS NOT NULL)");

            migrationBuilder.CreateIndex(
                name: "periods_company_id_26f76f0a",
                schema: "accounting",
                table: "periods",
                column: "company_id");

            migrationBuilder.CreateIndex(
                name: "periods_company_id_name_ad5ced7a_uniq",
                schema: "accounting",
                table: "periods",
                columns: new[] { "company_id", "name" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "periods_previous_period_id_785fc09e",
                schema: "accounting",
                table: "periods",
                column: "previous_period_id");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__settings__E72BC7672241685D",
                schema: "accounting",
                table: "settings",
                column: "domain_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "slave_accounts_from_company_id_6eb00e83",
                schema: "accounting",
                table: "slave_accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "trash_voucher_items_bank_account_for_bank_operation_id_e76292ef",
                schema: "accounting",
                table: "trash_voucher_items",
                column: "bank_account_for_bank_operation_id");

            migrationBuilder.CreateIndex(
                name: "trash_voucher_items_bank_account_for_payable_doc_id_7f5e5951",
                schema: "accounting",
                table: "trash_voucher_items",
                column: "bank_account_for_payable_doc_id");
            ...
            migrationBuilder.CreateIndex(
                name: "trash_voucher_items_bank_operation_bank_id_bb1c1a26",
                schema: "accounting",
                table: "trash_voucher_items",
                column: "bank_operation_bank_id");
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_buy__A2D3D11BC2C7726D",
                schema: "accounting",
                table: "ttms_buys",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_con__A2D3D11BA8538DEB",
                schema: "accounting",
                table: "ttms_contractor_infos",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_emp__A2D3D11BFA67BAD0",
                schema: "accounting",
                table: "ttms_employer_infos",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_exp__A2D3D11BD5437FE0",
                schema: "accounting",
                table: "ttms_exportations",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_imp__A2D3D11BC040759A",
                schema: "accounting",
                table: "ttms_importations",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_lea__A2D3D11B4215A57D",
                schema: "accounting",
                table: "ttms_lease_agreements",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_pre__A2D3D11B6438312A",
                schema: "accounting",
                table: "ttms_pre_sells",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_pro__357D4CF9C0B0C704",
                schema: "accounting",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_sel__A2D3D11B288B1E3D",
                schema: "accounting",
                table: "ttms_sells",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__ttms_wag__A2D3D11BF10A8DFE",
                schema: "accounting",
                table: "ttms_wages",
                column: "voucher_item_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "voucher_item_logs_bank_account_for_bank_operation_id_85e1fa5c",
                schema: "accounting",
                table: "voucher_item_logs",
                column: "bank_account_for_bank_operation_id");

            migrationBuilder.CreateIndex(
                name: "voucher_item_logs_bank_account_for_payable_doc_id_02b845e2",
                schema: "accounting",
                table: "voucher_item_logs",
                column: "bank_account_for_payable_doc_id");
            ...
            migrationBuilder.CreateIndex(
                name: "voucher_item_logs_bank_operation_bank_id_b643fc5c",
                schema: "accounting",
                table: "voucher_item_logs",
                column: "bank_operation_bank_id");
            ...
            migrationBuilder.CreateIndex(
                name: "voucher_items_bank_account_for_bank_operation_id_80a91c5d",
                schema: "accounting",
                table: "voucher_items",
                column: "bank_account_for_bank_operation_id");

            migrationBuilder.CreateIndex(
                name: "voucher_items_bank_account_for_payable_doc_id_e32d7b72",
                schema: "accounting",
                table: "voucher_items",
                column: "bank_account_for_payable_doc_id");
            ...
            migrationBuilder.CreateIndex(
                name: "voucher_items_bank_operation_bank_id_4c8c62c1",
                schema: "accounting",
                table: "voucher_items",
                column: "bank_operation_bank_id");

            migrationBuilder.CreateIndex(
                name: "voucher_items_bank_operation_type_for_payable_doc_id_8181f587",
                schema: "accounting",
                table: "voucher_items",
                column: "bank_operation_type_for_payable_doc_id");
            ...
            migrationBuilder.CreateIndex(
                name: "voucher_items_cross_reference_id_4dd4e885",
                schema: "accounting",
                table: "voucher_items",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__voucher___2E0A7AA612570483",
                schema: "accounting",
                table: "voucher_types",
                column: "name_fa",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "vouchers_last_status_modifier_id_f7d322ae",
                schema: "accounting",
                table: "vouchers",
                column: "last_status_modifier_id");
