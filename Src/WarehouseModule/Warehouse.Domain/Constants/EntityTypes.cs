...
public static class EntityTypes
{
    ...
    public const string InventoryMovementType = "INVENTORY_MOVEMENT_TYPE";
    public const string InventoryMovement = "INVENTORY_MOVEMENT";
    public const string InventoryLot = "INVENTORY_LOT";
    public const string InventoryLotAttributeValue = "INVENTORY_LOT_ATTRIBUTE_VALUE";
